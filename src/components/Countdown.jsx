...
const CountdownUnit = ({ count, type }) => (
  ...
  >
    ...
    <div style={{ fontSize: '0.8rem', fontWeight: 500, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '1px' }}>
      {type}
    </div>
  </motion.div>
);
...
const Countdown = ({ targetDate }) => {
  ...
  return (
    <section className="container" style={{ textAlign: 'center' }}>
      <h2 style={{ marginBottom: '2.5rem', color: 'var(--text-main)' }}>Hitung Mundur Acara</h2>
      <div 
        style={{
          display: 'flex',
          gap: '1rem',
